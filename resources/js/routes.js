window.routes = {
    PREFIX_V1: "/api/v1",
    addresses: function(id = null){return id == null ? `${this.PREFIX_V1}/addresses` : `${this.PREFIX_V1}/addresses/${id}`},
    ...
    assignment_finish: function(assignment_id){return `${this.PREFIX_V1}/assignments/${assignment_id}`},
    assignments_card_finish: function(card_id){return `${this.PREFIX_V1}/cards/${card_id}/assignments`},
    user_assignments: function(user_id){return `${this.PREFIX_V1}/assignments/user/${user_id}`},
