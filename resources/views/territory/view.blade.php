        ...
        <div class="col s10 offset-s2">
            <div class="card blue darken-2 z-depth-2 center">
                <span class="white-text">
                    <p style="font-size: 20px; padding-top: 3%;padding-bottom: 3%;"><span
                            style="font-weight: bolder">Instructor</span> {{$address->publisher->name}}</p>
                </span>
            </div>
        </div>
    </div>
                                ...
                                <div class="row mb-0">
                                    <div class="col">
                                        <div class="valign-wrapper">
                                            <i class="material-icons medium valign-wrapper"
                                                style="padding-top: 18%">account_circle</i>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="row mb-0">
